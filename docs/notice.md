...
1. 增加OAuth 2.0、OIDC 1.0支持，符合多项RFC规范。
...
如需修改密码，请在统一认证登录页面点击「忘记密码」按提示操作。
